...
.faq-modal-content{width:100%;max-width:840px;max-height:85vh;overflow-y:auto;background-image:url('/images/dashboard-background.png');background-size:cover;background-position:center;border:1.5px solid rgba(255,255,255,0.4);border-radius:24px;padding:3rem 2rem;position:relative;box-shadow:0 20px 50px rgba(0,0,0,0.15);scrollbar-width:thin;}
