                      ...
                      <div className={`grid grid-cols-2 ${reveal.mode === 'reveal' ? 'sm:grid-cols-3 lg:grid-cols-6' : 'md:grid-cols-4'} gap-4`}>
                        <div className="bg-pink-50/60 rounded-xl p-3 border border-pink-100 flex flex-col items-center text-center gap-1.5">
                          ...
                          <div className="min-w-0">
                            ...
                            <span className="text-xs font-semibold text-gray-800 block break-words">{reveal.mode === "announcement" ? "We Already Know!" : "Surprise Reveal"}</span>
                          </div>
                        </div>
                        {reveal.mode === "reveal" && (
                          <>
                            <div className="bg-pink-50/60 rounded-xl p-3 border border-pink-100 flex flex-col items-center text-center gap-1.5">
                              ...
                              <div className="min-w-0">
                                ...
                                <span className="text-xs font-semibold text-gray-800 block break-words">{formatRevealDate(reveal.revealAt)}</span>
                              </div>
                            </div>
                            <div className="bg-blue-50/60 rounded-xl p-3 border border-blue-100 flex flex-col items-center text-center gap-1.5">
                              ...
                              <div className="min-w-0">
                                ...
                                <span className="text-xs font-semibold text-gray-800 block break-words">{reveal.revealTimezone}</span>
                              </div>
                            </div>
                          </>
                        )}
                        <div className="bg-blue-50/60 rounded-xl p-3 border border-blue-100 flex flex-col items-center text-center gap-1.5">
                          ...
                          <div className="min-w-0">
                            ...
                            <span className="text-xs font-bold text-gray-800 block break-words">{getPaymentStatusLabel(reveal.paymentStatus)}</span>
                          </div>
                        </div>
                        {reveal.mode === "reveal" && (
                          <>
                            <div className="bg-blue-50/60 rounded-xl p-3 border border-blue-100 flex flex-col items-center text-center gap-1.5">
                              ...
                              <div className="min-w-0">
                                ...
                                <span className="text-xs font-semibold text-gray-800 block break-words">{reveal.revealerName || "Not Set"}</span>
                              </div>
                            </div>
                            <div className="bg-pink-50/60 rounded-xl p-3 border border-pink-100 flex flex-col items-center text-center gap-1.5">
                              ...
                              <div className="min-w-0">
                                ...
                                <span className="text-xs font-semibold text-gray-800 block break-words">{reveal.revealerEmail || "Not Set"}</span>
                              </div>
                            </div>
                          </>
                        )}
        ...
        {latestPartyReveal && (
          <section className="space-y-6">
            <div className="bg-white/40 backdrop-blur-md border border-white/30 shadow-lg rounded-2xl p-4 shadow-sm mb-4 flex items-center justify-between gap-3">
              ...
              <IconImg
                src="/images/icon-teddy.png"
                className="hidden sm:block w-28 h-28 object-contain shrink-0"
              />
            </div>
      ...
      <div className="pricing-section-container">
        {plans.map((plan) => {
          ...
          const p = {
            ...
            imgSrc: isBasic ? "/images/little-bundle-plan.png" : "/images/bundle-of-joy.png",
